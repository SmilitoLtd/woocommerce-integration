...
class BasketManager
{
	 ...
	 * @return int
	 */
	public function getOrderTotals(WC_Order|string $order): int
	{
		if (is_string($order)) {
	 ...
	 * @return string|null
	 */
	public function getBasketId(WC_Order|string $order = null): string|null
	{
		if ($order === null) {
	...
	private function getBasketIdFromSession(): string|null
	{
	...
	private function getBasketIdFromOrder(WC_Order|string $order): string|null
	{
		if (is_string($order)) {
			$order = wc_get_order($order);
		}
